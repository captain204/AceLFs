        ...
        <div className="row align-items-center">
          <div className="col-xl-6 col-lg-6">
            <div className="it-about-4-thumb-wrap d-flex align-items-center justify-content-center justify-content-lg-end">
              <div className="it-about-4-thumb-double d-flex flex-column">
                ...
                />
                <Image
                  src="/img/about/Acedars-news-2.jpg"
                  alt=""
                  width={236}
                  height={350}
                />
              ...
              <div className="it-about-4-thumb-single">
                <Image
                  src="/img/about/ACEDARS-News-3.png"
                  alt=""
                  width={304}
                  height={600}
                />
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="it-about-3-title-box">
              ...
              African Centre of Excellence for Drug Research, Herbal Medicine Development and Regulatory Science <span>(ACEDHARS)</span>
              </h2>
              <p>
            ...
            <h2 className="it-section-title-3 pb-30">
              Expected Results of ACEDHARS Intervention
              </h2>
              <p>
                ...
                <div className="col-xl-12">
                  <div className="it-about-4-list-wrap d-flex align-items-start">
                    ...
                    <div className="it-about-3-mv-item">
                      ...
                      <p>
                      To build up manpower on quality assurance, standardization of dosages, reproducibility of herbal preparations, drug development, drug repurposing and safety monitoring of drugs in West and Central African region.
                ...
                <div className="col-xl-12">
                  <div className="it-about-4-list-wrap d-flex align-items-start">
                    ...
                    <div className="it-about-3-mv-item">
                      ...
                      <p>
                      To provide intervention through training and research in the production of standard herbal products for the treatment of some prevalent NCDs in the region as well as enhancing information database for quality control and post-marketing surveillance.
