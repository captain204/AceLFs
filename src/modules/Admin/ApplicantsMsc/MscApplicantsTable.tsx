...
function ClientSideTable() {
  ...
  const applicants =
    useSelector((state: RootState) => state?.degreetypeapplicants?.applicants) || [];
  ...
  const handleConfirm = async () => {
    ...
    handleCloseModal();
    dispatch(getDegreeTypeApplicants("MSC"));
  };
...
export default MSCApplicantsTable;
