...
function ClientSideTable() {
  ...
  useEffect(() => {
    dispatch(getDegreeTypeApplicants(2));
  }, [dispatch]);
  ...
  const exportPDF = () => {
    const doc = new jsPDF();
    doc.text("MPhil Applicants", 14, 20);
...
export default function MphilApplicantsTable() {
  return (
    <div>
      <NoSSRTable />
    </div>
...
//     }
//     handleCloseModal();
//     dispatch(getDegreeTypeApplicants("M.PHIL"));
//   };
...
// export default MphilApplicantsTable;
