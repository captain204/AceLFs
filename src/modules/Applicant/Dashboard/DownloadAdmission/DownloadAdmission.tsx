...
//   const { user } = session;
  const userName = "Nurudeen Akindele ILiasu"; // Adjust based on your user object structure
  const regNumber =  "PGS/21-22/M-8902"; // Adjust based on your user object structure
  ...
  const generatePDF = () => {
    ...
    cursorY += lineHeight;
    doc.text(`Ref: ${regNumber}`, margin, cursorY);
    cursorY += lineHeight;
    ...
    doc.text(`Name of Student: ${userName}`, margin, cursorY);
    cursorY += lineHeight;
    ...
    doc.text("PROVISIONAL ADMISSION INTO POSTGRADUATE PROGRAMME", margin, cursorY);
    cursorY += lineHeight * 2;
    ...
    textBody.forEach((text, index) => {
      const lines = doc.splitTextToSize(text, 180); // 180 is the width of the text area
      lines.forEach(line => {
        doc.text(line, margin, cursorY);
        cursorY += lineHeight;
      });
      cursorY += index === 2 ? lineHeight : lineHeight * 0.5; // Extra space after conditions title
    });
  ...
  return (
    <Container>
      <Box sx={{ padding: '20px', backgroundColor: '#f0f8ff', borderRadius: '8px' }}>
        <Typography variant="h4" gutterBottom style={{ color: '#00008B', textAlign: 'center' }}>
          ABUBAKAR TAFAWA BALEWA UNIVERSITY, (ATBU)
        </Typography>
        <Typography variant="h5" gutterBottom style={{ color: '#00008B', textAlign: 'center' }}>
          BAUCHI
        </Typography>
        ...
        <Typography variant="body1" gutterBottom style={{ textAlign: 'center' }}>
          Ref: {regNumber} | Date: 25-Jan-2022
        </Typography>
        <Typography variant="body1" gutterBottom>
          <strong>Name of Student:</strong> {userName}
        </Typography>
        ...
        <Typography variant="body1" paragraph>
          I am pleased to inform you that on the recommendation of the Board of the Postgraduate School and the approval of the
          University Senate, you have been offered provisional admission in the 2021/2022 Academic Session to pursue a
          Full-Time course leading to M.Sc. Management Information Technology.
        </Typography>
        <Typography variant="body1" paragraph>
          The course will normally last 24 – 30 Months. The programme will commence immediately.
          You are expected to register for your course not later than two (2) weeks from the date of commencement of the
          Academic Session.
        </Typography>
        <Typography variant="body1" paragraph>
          The offer is subject to the following conditions:-
        ...
        <Box component="ol" sx={{ paddingLeft: '20px' }}>
          <li>That the particulars provided in your application form are correct in every respect.</li>
          <li>That your former University/College has sent your academic transcript.</li>
          <li>That you will tender your original credentials for inspection at the time of registration.</li>
          <li>That you will pay at least 2/3 of the tuition fees at registration. The tuition fee is currently
            145,500.00 for the first registration and subsequently 108,750.00 per session.</li>
          <li>You may be required to remedy some courses to be determined at the time of registration.</li>
          <li>School fees may be reviewed in due course.</li>
          <li>You will pay an acceptance fee of 5,000.</li>
          <li>You are also expected to satisfy other Faculty and Department requirements as they may apply.</li>
        </Box>
        <Typography variant="body1" paragraph>
          Please note that ALL Postgraduate Students registration is only complete upon payment of appropriate
          tuition and other fees. The University has limited accommodation on campus for postgraduate students offered on
        ...
        <Typography variant="body1" paragraph>
          If you accept the offer, please complete the attached acceptance form and forward the same to the undersigned
          no later than two (2) weeks from the date of this letter.
        </Typography>
        <Typography variant="body1" paragraph>
          Accept my congratulations.
        </Typography>
...
//   //   const { user } = session;
//   const userName = "Nurudeen Akindele ILiasu";
//   const regNumber = "PGS/21-22/M-8902";
...
//     `;
//     const contactInfo = `
//       Website: www.pgatbu.com.ng
//       Email: pgsch@atbu.edu.ng
//       Ref: ${regNumber}
//       Date: 25-Jan-2022
//     `;
//     const letterBody = `
...
//       The offer is subject to the following conditions:-
//       i. That the particulars provided in your application form are correct in every respect.
//       ii. That your former University/College has sent your academic transcript.
//       iii. That you will tender your original credentials for inspection at the time of registration.
//       iv. That you will pay at least 2/3 of the tuition fees at registration. The tuition fee is currently
//          145,500.00 for the first registration and subsequently 108,750.00 per session.
//       v. You may be required to remedy some courses to be determined at the time of registration.
//       vi. School fees may be reviewed in due course.
//       vii. You will pay an acceptance fee of 5,000.
//       viii. You are also expected to satisfy other Faculty and Department requirements as they may apply.
...
//     doc.setFont("times", "normal");
//     doc.setTextColor("#000000");
//     doc.text(contactInfo, 10, 30);

//     doc.setFont("times", "normal");
//     doc.setTextColor("#000000");
//     doc.text(letterBody, 10, 50);
