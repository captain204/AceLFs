...
export default function Newsletter() {
  return (
    <div
      id="it-newsletter"
      className="it-newsletter-area it-newsletter-height fix p-relative theme-bg"
    >
      <div className="it-newsletter-shape-1 d-none d-lg-block">
        <Image
          src="/img/newsletter/shape-1-1.png"
          alt=""
          width={302}
          height={268}
        />
      ...
      <div className="it-newsletter-shape-2 d-none d-lg-block">
        <Image
          src="/img/newsletter/shape-1-2.png"
          alt=""
          width={392}
          height={223}
        />
      ...
      <div className="it-newsletter-shape-3 d-none d-xl-block">
        <Image
          src="/img/newsletter/shape-1-3.png"
          alt=""
          width={66}
          height={65}
        />
      ...
      <div className="it-newsletter-shape-4 d-none d-xl-block">
        <Image
          src="/img/newsletter/shape-1-4.png"
          alt=""
          width={77}
          height={85}
        />
