    ...
    <>
      <header>
        <div className="it-header-transparent">
          <div className="it-header-2-top-area it-header-3-top it-header-2-top-height white-bg">
            <div className="container">
              <div className="row align-items-center">
                <div className="col-xl-8 col-lg-8 col-md-5 col-7">
                ...
                <div className="col-xl-4 col-lg-4 col-md-7 col-5">
                  <div className="it-header-2-top-right text-end">
                    <ul>
                      <li className="d-none d-md-inline-block">
                        <div className="it-header-3-top-right">
                          <a href="/login">
                            <span className="icon">
          ...
          <div
            id="header-sticky"
            className={`it-header-2-area it-header-3-style ${
