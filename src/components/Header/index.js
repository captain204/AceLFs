                ...
                <div className="col-xl-8 col-lg-8 col-md-5 col-sm-4">
                  <div className="it-header-2-top-left">
                    <ul className="text-center text-sm-start">
                      ...
                      <li>
                        <Link href="mailto:acedhars@unilag.edu.ng">
                          <span>
                            <svg
                              width="20"
                              height="20"
                    ...
                    <ul>
                      <li>
                        <div className="it-header-2-top-social">
                          <Link href="www.facebook.com/acedhars-unilag">
                            <i className="fab fa-facebook-f"></i>
                          </Link>
                          <Link href="www.twitter.com/acedhars-unilag">
                            <i className="fab fa-twitter"></i>
                          </Link>
                          <Link href="www.linkedin.com/in/acedhars-unilag">
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-xl-7 d-none d-xl-block">
                      <div className="it-header-2-main-menu">
                        <nav className="it-menu-content"></nav>
